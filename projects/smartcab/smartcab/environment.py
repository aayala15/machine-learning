...
class Environment(object):
    ...
    def __init__(self):
        ...
        self.roads = []
        for x in list(range(self.bounds[0], self.bounds[2] + 1)):
            for y in list(range(self.bounds[1], self.bounds[3] + 1)):
        ...
        for i in list(range(self.num_dummies)):
    ...
    def step(self):
        ...
        # Update agents
        for agent, _ in self.agent_states.items():
            agent.update(self.t)
